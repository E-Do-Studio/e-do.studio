    ...
    return(
        <div className="galeriePC" style={{cursor:'url(cursor/cursor.svg), auto'}}>
            <ScrollContainer className="galeriePCWrapper" onScroll={handleScroll} hideScrollbars={false}>
                <IMGPC linkUrl="/service-mannequin-vertical" src="jean-paul-gaultier-corset-jean.jpg" lar="13" haut="22" ajustHauteurTop="" ajustHauteurBottom="7" anim={1} scrollX={scrollX} />
                <IMGPC linkUrl="/service-mannequin-vertical" src="pantalon-le-kasha.jpg" lar="18" haut="27" ajustHauteurTop="7" ajustHauteurBottom="" anim={1} scrollX={scrollX} />
                <IMGPC linkUrl="/service-mannequin-vertical" src="veste-de-fursac.png" lar="13" haut="20" ajustHauteurTop="15" ajustHauteurBottom="" anim={1} scrollX={scrollX} />
                <IMGPC linkUrl="/service-mannequin-vertical" src="col-roule-vuarnet-boramy.png" lar="18" haut="27" ajustHauteurTop="7" ajustHauteurBottom="" anim={1} scrollX={scrollX} />
                <IMGPC linkUrl="/service-mannequin-vertical" src="echarpe-vuarnet.png" lar="13" haut="22" ajustHauteurTop="" ajustHauteurBottom="14" anim={1} scrollX={scrollX} />
                <IMGPC linkUrl="/service-mannequin-vertical" src="gilet-hit-air.jpg" lar="15" haut="20" ajustHauteurTop="" ajustHauteurBottom="20" anim={1} scrollX={scrollX} />
                <IMGPC linkUrl="/service-mannequin-vertical" src="gilet-vuarnet-boramy.jpg" lar="17" haut="25" ajustHauteurTop="" ajustHauteurBottom="" anim={1} scrollX={scrollX} />
                <IMGPC linkUrl="/service-mannequin-vertical" src="haut-loverboy.jpg" lar="13" haut="20" ajustHauteurTop="20" ajustHauteurBottom="" anim={1} scrollX={scrollX} />
                <IMGPC linkUrl="/service-mannequin-vertical" src="manteau-ninamounah.jpg" lar="16" haut="22" ajustHauteurTop="7" ajustHauteurBottom="" anim={1} scrollX={scrollX} />
                <IMGPC linkUrl="/service-mannequin-vertical" src="mesh-top-ottolinger.jpg" lar="18" haut="27" ajustHauteurTop="" ajustHauteurBottom="7" anim={1} scrollX={scrollX} />
                <IMGPC linkUrl="/service-mannequin-vertical" src="mina-storm-panties-patch-work.png" lar="24" haut="33" ajustHauteurTop="" ajustHauteurBottom="20" anim={1} scrollX={scrollX} />
                <IMGPC linkUrl="/service-mannequin-vertical" src="pantalon-ninamounah.jpg" lar="18" haut="26" ajustHauteurTop="" ajustHauteurBottom="7" anim={1} scrollX={scrollX} />
                <IMGPC linkUrl="/service-mannequin-vertical" src="parka-de-fursac.jpg" lar="13" haut="20" ajustHauteurTop="" ajustHauteurBottom="" anim={1} scrollX={scrollX} />
                <IMGPC linkUrl="/service-mannequin-vertical" src="robe-ninamounah.png" lar="15" haut="24" ajustHauteurTop="" ajustHauteurBottom="7" anim={1} scrollX={scrollX} />
                <IMGPC linkUrl="/service-mannequin-vertical" src="veste-a-capuche-loverboy.jpg" lar="18" haut="27" ajustHauteurTop="" ajustHauteurBottom="12" anim={1} scrollX={scrollX} />
                <IMGPC linkUrl="/service-mannequin-vertical" src="veste-blazer-back-view-vintage-operandi.jpg" lar="18" haut="26" ajustHauteurTop="10" ajustHauteurBottom="" anim={1} scrollX={scrollX} />
                <IMGPC linkUrl="/service-mannequin-vertical" src="top-misbhv.jpg" lar="15" haut="20" ajustHauteurTop="" ajustHauteurBottom="15" anim={1} scrollX={scrollX} />
                <IMGPC linkUrl="/service-mannequin-vertical" src="top-paco-rabane.jpg" lar="17" haut="25" ajustHauteurTop="" ajustHauteurBottom="5" anim={1} scrollX={scrollX} />
    ...
    return (
        <>
            <Helmet defer={false}>
                ...
                <meta name="description" content="Explorez les possibilités de productions de contenus photos offertes par notre machine Vertical." />
            ...
            <div className="pageGalerie">
                ...
                <div className='titreAnimationWrapper'>
                    ...
                    <ul>
                        ...
                        <Link to="/galerie-vertical"><li className="active">Vertical</li></Link>
